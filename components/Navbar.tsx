        ...
        <div className="w-[114px] h-[747px] bg-[#EFEFEF] rounded-[87px] flex justify-center items-center flex-col space-y-24">
            ...
            <Link href={"/profile"}>
                {router === "/profile" ? (
                    ...
                    <path d="M21.4651 22.1148C27.0874 22.1148 31.6451 17.557 31.6451 11.9348C31.6451 6.3125 27.0874 1.75476 21.4651 1.75476C15.8428 1.75476 11.2851 6.3125 11.2851 11.9348C11.2851 17.557 15.8428 22.1148 21.4651 22.1148Z" fill="#262626" stroke="#262626" strokeWidth="3" stroke-miterlimit="10"/>
                    <path d="M2.18512 34.9248C2.18512 30.9648 5.42512 27.7248 9.38512 27.7248L33.5551 27.7248C37.5151 27.7248 40.7551 30.9648 40.7551 34.9248V38.8148L2.18512 38.8148L2.18512 34.9248Z" fill="#262626" stroke="#262626" strokeWidth="3" stroke-miterlimit="10"/>
                    </svg>
                ) : (
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
